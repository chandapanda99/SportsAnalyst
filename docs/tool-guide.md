...
Desktop progress and retry state survive restarts in `jobs.sqlite3`; datasets, investigations, exports, and the DuckDB catalog remain separate files in the same per-user data
directory.
